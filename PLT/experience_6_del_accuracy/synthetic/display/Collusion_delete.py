...
def plt_LAFC():
    ...
    """MV"""
    x = range(len(names))
    mean1 = list(pd.read_csv("transform_MV_acc_0.8.csv")["experience_3_collusion_accuracy"])
    var1 = list(pd.read_csv("transform_MV_acc_0.8.csv")["char"])
    ...
    """GLAD"""
    mean2 = list(pd.read_csv("transform_GLAD_acc_0.8.csv")["experience_3_collusion_accuracy"])
    var2 = list(pd.read_csv("transform_GLAD_acc_0.8.csv")["char"])
    ...
    """HDS"""
    mean2 = list(pd.read_csv("transform_HDS_acc_0.8.csv")["experience_3_collusion_accuracy"])
    var2 = list(pd.read_csv("transform_HDS_acc_0.8.csv")["char"])
    ...
    plt.ylabel("experience_3_collusion_accuracy", size=14)  # Y轴标签
...
if __name__ == '__main__':
    ...
    # path_GLAD = "GLAD_acc_0.8.csv"
    # Synthetic(path_GLAD, 0.835192)
    # path_MV = "MV_acc_0.8.csv"
    # Synthetic(path_MV, 0.821561)
    # path_HDS = "HDS_acc_0.8.csv"
