...
def Synthetic(path, source_acc):
    Proportion = [0, 0.6, 0.7, 0.8, 0.9, 1.0]
...
def plt_LAFC():
    ...
    """MV"""
    x = range(len(names))
    mean1 = list(pd.read_csv("transform_MV_acc_collusion_all-36.csv")["experience_3_collusion_accuracy"])
    var1 = list(pd.read_csv("transform_MV_acc_collusion_all-36.csv")["char"])
    ...
    """GLAD"""
    mean2 = list(pd.read_csv("transform_GLAD_acc_collusion_all-36.csv")["experience_3_collusion_accuracy"])
    var2 = list(pd.read_csv("transform_GLAD_acc_collusion_all-36.csv")["char"])
    ...
    """HDS"""
    mean2 = list(pd.read_csv("transform_HDS_acc_collusion_all-36.csv")["experience_3_collusion_accuracy"])
    var2 = list(pd.read_csv("transform_HDS_acc_collusion_all-36.csv")["char"])
    ...
    path = 'result_collusion_30%_synthetic.jpg'
...
if __name__ == '__main__':
    ...
    path_GLAD = "GLAD_acc_collusion_all-36.csv"
    Synthetic(path_GLAD, 0.962500)

    path_MV = "MV_acc_collusion_all-36.csv"
    Synthetic(path_MV, 0.928750)

    path_HDS = "HDS_acc_collusion_all-36.csv"
    Synthetic(path_HDS, 0.973750)
