...
def Mean_Var(path):
    ...
    for i in range(len(index)):
        ...
        path = "../../collusion_P_0.8/KCDN_W(废)/"+str(Algorithm)+"/KCDN_Percentage_"+str(index[i])+"_0.csv"
    ...
    save_path = "../../collusion_P_0.8/KCDN_W(废)/"+str(Algorithm)+"/Mean_Var.csv"
...
def Plt(xx):
    ...
    plt.ylabel("KCDN_W(废)-"+xx, size=18)  # Y轴标签
