...
if __name__ == '__main__':
    ...
    # 获取串谋数据及的分布情况
    collusion_result_6 = []
    collusion_result_6 = get_collusion_result(collusion_P, 12)
    print(12)

    # 获取串谋数据及的分布情况
    collusion_result_7 = []
    collusion_result_7 = get_collusion_result(collusion_P, 24)
    print(24)

    # 获取串谋数据及的分布情况
    collusion_result_8 = []
    collusion_result_8 = get_collusion_result(collusion_P, 36)
    print(36)

    # 获取串谋数据及的分布情况
    collusion_result_9 = []
    collusion_result_9 = get_collusion_result(collusion_P, 48)
    print(48)

    # 获取串谋数据及的分布情况
    collusion_result_10 = []
    collusion_result_10 = get_collusion_result(collusion_P, 60)
    print(60)
    ...
    path = 'Beta_synthetic_percentage.jpg'
