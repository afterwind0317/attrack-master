...
def Percentage(collusion_P, pre, alpha, beta, gama, K, epoch):

    print("collusion_P=", collusion_P, "alpha=", alpha, "beta=", beta, "gama=", gama, "KCDN_percentage=", pre, "dection=",
          pre, "epoch=", epoch)
...
def display_Percentage(collusion_P, percentage, alpha, beta, gama, K, epoch):
    ...
    for pre in range(len(percentage)):
        ...
        for epo in range(epoch, epoch + 30):
            (acc1, pre1, rec1, f1_score) = Percentage(collusion_P, percentage[pre], alpha, beta, gama, K, epo)
        ...
        # save_path = "../../result/collusion_data/collusion_0.8/KCDN_percentage/collusion_detect_"+str(percentage[pre])+".csv"
...
if __name__ == '__main__':
    ...
    display_Percentage(collusion_P, percentage, alpha[0], beta[0], gama[0], K, 0)