...
def GLAD(collusion_P, list, truth_file):
        ...
        for i in range(len(list)):
            ...
            for epo in range(30):
                ...
                datafile = "../../../experience/result/collusion_data/collusion_" + str(
                    collusion_P[p]) + "/experience_" + str(list[i]) + "/data" + str(epo) + "_collaborate_D.csv"
                ...
                W[i][epo] = accuracy
            save_path = "../../../experience/acc_result/GLAD_acc_collusion_"+str(collusion_P[p])+"-"+str(list[i])+".csv"
...
def HDS(collusion_P, list, truth_file):
    ...
    for p in range(len(collusion_P)):
        ...
        for i in range(len(list)):
            ...
            for epo in range(30):
                print(list[i], epo, "/", 30)
                datafile = "../../../experience/result/collusion_data/collusion_"+str(collusion_P[p])+"/experience_"+str(list[i])+"/data"+str(epo)+"_collaborate_D.csv"
                ...
                W[i][epo] = accuracy
                #
            save_path = "../../../experience/acc_result/HDS_acc_collusion_"+str(collusion_P[p])+"-"+str(list[i])+".csv"
            np.savetxt(save_path, W, delimiter=",", fmt='%.8f')
...
def MV(collusion_P, list, gt_data):
    ...
    for p in range(len(collusion_P)):
        ...
        for i in range(len(list)):
            ...
            save_path = "../../../experience/acc_result/MV_acc_collusion_"+str(collusion_P[p])+"-"+str(list[i])+".csv"
            np.savetxt(save_path, W, delimiter=",", fmt='%.8f')
...
if __name__ == '__main__':
    ...
    truth_file = "../../../data/demo_result_file.csv"
