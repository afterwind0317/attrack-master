...
def display_Top(collusion_P, percentage, tops, alpha, beta, gama, epoch):
    ...
    for t in range(len(tops)):
        ...
        for epo in range(epoch, epoch + 30):
            (acc1, pre1, rec1, f1_score) = Top(collusion_P, percentage[0], tmp_top, alpha, beta, gama, epo)
...
if __name__ == '__main__':
    ...
    display_Top(collusion_P, percentage, tops, alpha[0], beta[0], gama[0], 0)
